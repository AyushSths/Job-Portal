        ...
        <>
            ...
            <div className="search-section" style={{ maxWidth: "1820px", margin: "0 auto" }}>
                <div className="info" style={{ margin: "auto", padding: "0 10px" }}>
                    <p style={{ opacity: "0.8", marginBottom: "30px", marginTop: "-20px", fontSize: "16px" }}> <Link to="/" className="link" style={{ color: "white" }}>Home</Link>  / Search results for : {search_term}</p>
