            ...
            <div className="user-form" >
                <form class="form" onSubmit={handleSubmit}>
                    ...
                    <div class="inputForm">
                        ...
                        <input placeholder="Enter your Email" class="input" type="email" name='email' value={data.email} onChange={handleChange} required />
                    </div>
                    ...
                    <div class="inputForm">
                        ...
                        <input placeholder="Enter your Password" class="input" type="password" name='password' value={data.password} onChange={handleChange} required />
                    </div>
