                                    ...
                                    return (
                                        <>
                                            <tr key={details?._id}>
                                                ...
                                                <td><Link to={`/edit/${details?._id}`}><img src={edit} alt="" className="icon_hover" /></Link>
                                                    <Link to={`/${details?._id}`}><img src={eye} alt="" className="icon_hover" style={{ marginLeft: "20px" }} /></Link>
