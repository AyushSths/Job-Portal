...
export default function Jewellery(props) {
    ...
    return (
        <>
            {/* <Mainslide /> */}
            <div className=''><h2 class="categorey">Jewellery Categorey</h2>
                <div className="title-line products-line"></div>
                <p className='small'><b>Aaach Fashion Wear / Jewellery</b> - {
                    products ? (
                        <span>{products.filter(product => product.categories[0] === "jewelery").length} items</span>
                    ) : null}</p>
            ...
            <div className="row">
                    ...
                    <div className='side-form'>
                        <div class="form-check">
                            ...
                            <div className="list">
                                ...
                                <button onClick={() => filteredBran("John Hardy ")} >John Hardy</button>
                ...
                <div className="col-sm-10">
                    {products.filter(product => product.categories[0] === "jewelery").length === 0 ? (
