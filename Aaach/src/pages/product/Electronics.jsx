...
export default function Electronics(props) {
    ...
    return (
        <>
            {/* <Mainslide /> */}
            <div className=''><h2 class="categorey">Electronics Categorey</h2>
                <div className="title-line products-line"></div>
                <p className='small'><b>Aaach Fashion Wear / Electronics</b> - {
                    products ? (
                        <span>{products.filter(product => product.categories[0] === "electronics").length} items</span>
                    ) : null}</p>
            ...
            <div className="row">
                ...
                <div className="col-sm-10">
                    {products.filter(product => product.categories == "electronics").length === 0 ? (
