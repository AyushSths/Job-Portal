...
export default function Men(props) {
    ...
    return (
        <>
            {/* <Mainslide /> */}
            <div className=''><h2 class="categorey">Men's Categorey</h2>
                <div className="title-line products-line"></div>
                <p className='small'><b>Aaach Fashion Wear / Men</b> - {
                    products ? (
                        <span>{products.filter(product => product.categories[0] === "men's clothing").length} items</span>
                    ) : null}</p>
            ...
            <div className="row">
                ...
                <div className="col-sm-10">
                    {products.filter(product => product.categories[0] === "men's clothing").length === 0 ? (
